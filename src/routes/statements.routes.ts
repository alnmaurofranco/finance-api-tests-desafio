...
import { CreateTransferOperationController } from "../modules/statements/useCases/createTransfer/CreateTransferOperationController";
...
const createTransferOperationController =
  new CreateTransferOperationController();
...
statementRouter.post(
  ...
  createTransferOperationController.handle
);
